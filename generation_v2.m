function [ ...
    ...
    addDist = 0.89 * module;                     % Addendum distance
    dedDist = 1.0 * module;                     % Dedendum distance
    ...
    toolFullAngle = 60*pi/180;
    toolFluteLength = 20;
    toolDiameter = 6;
    toolStickOut = 30;
    cutSteps = 1;                               % How many steps to simulate a rack using tip tool
